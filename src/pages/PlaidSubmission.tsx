              ...
              <CardContent className="p-6">
                ...
                <div className="border rounded-lg overflow-hidden bg-muted mb-4">
                  <div className="w-full bg-gray-200 flex items-center justify-center" style={{ minHeight: '400px' }}>
                    <p className="text-gray-500 text-lg">Landing Page Screenshot - Add your screenshot here</p>
                  </div>
                </div>
          ...
          <div className="mb-10 page-break-before">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="border rounded-lg overflow-hidden bg-muted mb-4">
                  <div className="w-full bg-gray-200 flex items-center justify-center" style={{ minHeight: '400px' }}>
                    <p className="text-gray-500 text-lg">Auth Page Screenshot - Add your screenshot here</p>
                  </div>
                </div>
                <div className="p-4 bg-background border rounded-lg">
                  <p className="text-sm font-medium mb-2">Key Elements:</p>
          ...
          <div className="mb-10 page-break-before">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="border rounded-lg overflow-hidden bg-muted mb-4">
                  <div className="w-full bg-gray-200 flex items-center justify-center" style={{ minHeight: '400px' }}>
                    <p className="text-gray-500 text-lg">Snowball Plan Tab Screenshot - Add your screenshot here</p>
                  </div>
                </div>
                <div className="p-4 bg-background border rounded-lg">
                  <p className="text-sm font-medium mb-2">Key Elements:</p>
          ...
          <div className="mb-10 page-break-before">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="border rounded-lg overflow-hidden bg-muted mb-4">
                  <div className="w-full bg-gray-200 flex items-center justify-center" style={{ minHeight: '400px' }}>
                    <p className="text-gray-500 text-lg">Payoff Calendar Tab Screenshot - Add your screenshot here</p>
                  </div>
                </div>
                <div className="p-4 bg-background border rounded-lg">
                  <p className="text-sm font-medium mb-2">Key Elements:</p>
          ...
          <div className="mb-10 page-break-before">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="border rounded-lg overflow-hidden bg-muted mb-4">
                  <div className="w-full bg-gray-200 flex items-center justify-center" style={{ minHeight: '400px' }}>
                    <p className="text-gray-500 text-lg">Printable Summary Tab Screenshot - Add your screenshot here</p>
                  </div>
                </div>
                <div className="p-4 bg-background border rounded-lg">
                  <p className="text-sm font-medium mb-2">Key Elements:</p>
          ...
          <div className="mb-10 page-break-before">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="border rounded-lg overflow-hidden bg-muted mb-4">
                  <div className="w-full bg-gray-200 flex items-center justify-center" style={{ minHeight: '400px' }}>
                    <p className="text-gray-500 text-lg">Mobile View Tab Screenshot - Add your screenshot here</p>
                  </div>
                </div>
                <div className="p-4 bg-background border rounded-lg">
                  <p className="text-sm font-medium mb-2">Key Elements:</p>
