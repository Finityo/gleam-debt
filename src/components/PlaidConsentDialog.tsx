  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] sm:max-h-[80vh] overflow-hidden flex flex-col p-0">
        ...
        <div className="space-y-4 sm:space-y-6 py-3 sm:py-4 overflow-y-auto flex-1 min-h-0 px-4 sm:px-6">
          {/* Benefits Banner */}
        ...
        <div className="p-4 sm:p-6 pt-0">
          <DialogFooter className="flex-col sm:flex-row gap-2 flex-shrink-0 pt-3 sm:pt-4 border-t">
          <Button
            variant="outline"
